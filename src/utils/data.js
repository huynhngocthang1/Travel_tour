...
export const tourDetails = {
  ...
  des: ` Bali, hòn đảo nổi tiếng của Indonesia, được mệnh danh là "vùng đất của các vị thần" nhờ vào vẻ đẹp thiên nhiên tuyệt mỹ và nền văn hóa độc đáo. Nơi đây thu hút du khách với những bãi biển cát trắng trải dài, những cánh đồng lúa bậc thang xanh mướt và các ngôi đền cổ kính mang đậm dấu ấn Hindu giáo. Không chỉ là điểm đến lý tưởng cho những ai yêu thích biển, Bali còn là thiên đường cho những tín đồ đam mê yoga, lướt sóng và khám phá nghệ thuật địa phương. Với nền ẩm thực phong phú, con người hiếu khách và không gian yên bình, Bali chắc chắn là một địa điểm không thể bỏ qua cho những ai muốn tìm kiếm trải nghiệm du lịch đáng nhớ.`,
  price: "280.00",
  rating: " 4.5",
  reviews: "365 reviews",
  tourInfo: [
